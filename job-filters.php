...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_location resume-filter">
			...
			<?php 
			if(! is_tax( 'job_listing_region' ) && get_terms( 'job_listing_region' ) ) : ?>
			<label for="search_locations"><?php _e( 'Location', 'wp-job-manager-resumes' ); ?></label>
			<?php job_manager_dropdown_categories( array( 'taxonomy' => 'job_listing_region', 'hierarchical' => 1, 'name' => 'search_location','placeholder'=>'Choose a location' ,'orderby' => 'name', 'selected' => $selected_location, 'hide_empty' => false ) ); ?>
		...
		<!-- job manager add search button inbuilt function removed here -->
